package com.washingtin.jeenet.common.utils;
...
public class SendMailUtil {
    ...
    private static final String from = "washingtin@sina.com";
    private static final String fromName = "测试公司";
    private static final String charSet = "utf-8";
    private static final String username = "washingtin@sina.com";
