...
import com.washingtin.jeenet.common.security.Digests;
import com.washingtin.jeenet.common.security.shiro.session.SessionDAO;
import com.washingtin.jeenet.common.service.BaseService;
import com.washingtin.jeenet.common.service.ServiceException;
...
import com.washingtin.jeenet.common.web.Servlets;
import com.washingtin.jeenet.modules.sys.dao.MenuDao;
import com.washingtin.jeenet.modules.sys.dao.RoleDao;
import com.washingtin.jeenet.modules.sys.dao.UserDao;
...
import com.washingtin.jeenet.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
    ...
    public static boolean printKeyLoadMessage(){
        ...
        sb.append("\r\n======================================================================\r\n");
        sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://www.jeenet.com\r\n");
        sb.append("\r\n======================================================================\r\n");
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (isSynActivitiIndetity){
            ...
            // 同步角色数据
            List<Group> groupList = new ArrayList<Group>();//identityService.createGroupQuery().list();
            if (groupList.size() == 0){
...
//                    saveActivitiGroup(role);
            ...
            // 同步用户数据
            List<org.activiti.engine.identity.User> userList = new ArrayList<org.activiti.engine.identity.User>();//identityService.createUserQuery().list();
            if (userList.size() == 0){
